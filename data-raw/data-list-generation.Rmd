...
Compute Average Expression of Godzilla: combined RPE & choroid dataset
```{r}
...
data_list[["expression_list"]][["godzilla"]] <- avg_df

object <- readPicture("images/xml_files/new_pics/retina_rpe_chor_cartoon_all_2020_godzilla.ps.xml")
data_list[["object_labeled_list"]][["godzilla"]] <- object

object <- readPicture("images/xml_files/new_pics/retina_rpe_chor_cartoon_all_2020_godzilla_unlabeled.ps.xml")
data_list[["object_unlabeled_list"]][["godzilla"]] <- object
```
